...
if maestro_file and mapping_file:
    try:
        ...
        # Add Retainage Percent = Retainage / Grand Total
        retainage = pd.to_numeric(df_translated['Retainage'], errors='coerce')
        grand_total = pd.to_numeric(df_translated['Grand Total'], errors='coerce')
        df_translated['Retainage Percent'] = (retainage / grand_total).where(
            grand_total != 0
